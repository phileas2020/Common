...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
	    ...
	    static void AutoReigster() 
        { 
            CustomInternalGlobals.Init();
            DelegateBridgeProxy.Init();
		    XLua.LuaEnv.AddIniter(Init);
            ObjectTranslatorProxy.IniterAdderUnityEngineVector2.Init();
		}
...
namespace XLua
{
	...
	public partial class CustomInternalGlobals
    {
	    

	    public static void Init()
		{
		    InternalGlobalsProxy.extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
			    
			};
			
			InternalGlobalsProxy.genTryArrayGetPtr = StaticLuaCallbacksProxy.__tryArrayGet;
            InternalGlobalsProxy.genTryArraySetPtr = StaticLuaCallbacksProxy.__tryArraySet;
		}
	}
}
