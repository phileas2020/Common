...
namespace XLua
{
    public partial class DelegateBridgeProxy : DelegateBridge
    {
		...
		public void __Gen_Delegate_Imp3(float p0, float p1, float p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp7(bool p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp9(UnityEngine.Video.VideoPlayer p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp10(UnityEngine.Video.VideoPlayer p0, long p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp11(UnityEngine.Video.VideoPlayer p0, double p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp12(UnityEngine.Video.VideoPlayer p0, string p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public static void Init()
		{
		    ...
		    DelegateBridge.Creator = (int reference, LuaEnv luaenv) =>
            {
                return new DelegateBridgeProxy(reference, luaenv);
            };
		}
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<float, float, float>(__Gen_Delegate_Imp3);
			}
			...
			{
			    return new System.Action<bool, int>(__Gen_Delegate_Imp7);
			}
			...
			{
			    return new UnityEngine.Video.VideoPlayer.EventHandler(__Gen_Delegate_Imp9);
			}
		
		    if (type == typeof(UnityEngine.Video.VideoPlayer.FrameReadyEventHandler))
			{
			    return new UnityEngine.Video.VideoPlayer.FrameReadyEventHandler(__Gen_Delegate_Imp10);
			}
		
		    if (type == typeof(UnityEngine.Video.VideoPlayer.TimeEventHandler))
			{
			    return new UnityEngine.Video.VideoPlayer.TimeEventHandler(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(UnityEngine.Video.VideoPlayer.ErrorEventHandler))
			{
			    return new UnityEngine.Video.VideoPlayer.ErrorEventHandler(__Gen_Delegate_Imp12);
			}
