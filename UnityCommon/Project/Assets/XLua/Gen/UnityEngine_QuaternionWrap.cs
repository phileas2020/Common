    ...
    public class UnityEngineQuaternionWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 5 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5))
				{
					...
					proxy.PushUnityEngineQuaternion(L, gen_ret);
				...
				{
				    proxy.PushUnityEngineQuaternion(L, default(UnityEngine.Quaternion));
			        return 1;
				}
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<UnityEngine.Quaternion>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					UnityEngine.Quaternion gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
        ...
        static int __MulMeta(RealStatePtr L)
        {
			...
			try {
				...
				{
					UnityEngine.Quaternion leftside;proxy.Get(L, 1, out leftside);
					UnityEngine.Quaternion rightside;proxy.Get(L, 2, out rightside);
					
					proxy.PushUnityEngineQuaternion(L, leftside * rightside);
        ...
        static int _m_FromToRotation_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 _fromDirection;proxy.Get(L, 1, out _fromDirection);
                    UnityEngine.Vector3 _toDirection;proxy.Get(L, 2, out _toDirection);
        ...
        static int _m_Inverse_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Quaternion _rotation;proxy.Get(L, 1, out _rotation);
        ...
        static int _m_Slerp_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Quaternion _a;proxy.Get(L, 1, out _a);
                    UnityEngine.Quaternion _b;proxy.Get(L, 2, out _b);
        ...
        static int _m_AngleAxis_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _axis;proxy.Get(L, 2, out _axis);
        ...
        static int _m_LookRotation_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 _forward;proxy.Get(L, 1, out _forward);
                ...
                {
                    UnityEngine.Vector3 _forward;proxy.Get(L, 1, out _forward);
                    UnityEngine.Vector3 _upwards;proxy.Get(L, 2, out _upwards);
		    ...
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Set( _newX, _newY, _newZ, _newW );
                        ...
                        proxy.UpdateUnityEngineQuaternion(L, 1, gen_to_be_invoked);
        ...
        static int _m_SetLookRotation(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 _view;proxy.Get(L, 2, out _view);
                ...
                {
                    UnityEngine.Vector3 _view;proxy.Get(L, 2, out _view);
                    UnityEngine.Vector3 _up;proxy.Get(L, 3, out _up);
        ...
        static int _m_Euler_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.Vector3>(L, 1)) 
                {
                    UnityEngine.Vector3 _euler;proxy.Get(L, 1, out _euler);
        ...
        static int _m_ToAngleAxis(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    proxy.PushUnityEngineVector3(L, _axis);
        ...
        static int _m_SetFromToRotation(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 _fromDirection;proxy.Get(L, 2, out _fromDirection);
                    UnityEngine.Vector3 _toDirection;proxy.Get(L, 3, out _toDirection);
        ...
        static int _m_RotateTowards_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Quaternion _from;proxy.Get(L, 1, out _from);
                    UnityEngine.Quaternion _to;proxy.Get(L, 2, out _to);
        ...
        static int _m_Normalize_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Quaternion _q;proxy.Get(L, 1, out _q);
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Quaternion _other;proxy.Get(L, 2, out _other);
        ...
        static int _g_get_identity(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineQuaternion(L, UnityEngine.Quaternion.identity);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_eulerAngles(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Quaternion gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.eulerAngles);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_normalized(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Quaternion gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                proxy.PushUnityEngineQuaternion(L, gen_to_be_invoked.normalized);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_eulerAngles(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Quaternion gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                UnityEngine.Vector3 gen_value;proxy.Get(L, 2, out gen_value);
