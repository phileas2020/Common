...
namespace XLua
{
    public static partial class CopyByValueProxy
    {
		...
		public static void UnPack(ObjectTranslatorProxy proxy, RealStatePtr L, int idx, out UnityEngine.Vector2 val)
		{
			...
			if (Utils.LoadField(L, idx, "x"))
            {
                ...
                proxy.translator.Get(L, top + 1, out val.x);
			...
			if (Utils.LoadField(L, idx, "y"))
            {
                ...
                proxy.translator.Get(L, top + 1, out val.y);
		...
		public static void UnPack(ObjectTranslatorProxy proxy, RealStatePtr L, int idx, out UnityEngine.Vector3 val)
		{
			...
			if (Utils.LoadField(L, idx, "z"))
            {
                ...
                proxy.translator.Get(L, top + 1, out val.z);
		...
		public static void UnPack(ObjectTranslatorProxy proxy, RealStatePtr L, int idx, out UnityEngine.Vector4 val)
		{
			...
			if (Utils.LoadField(L, idx, "w"))
            {
                ...
                proxy.translator.Get(L, top + 1, out val.w);
		...
		public static void UnPack(ObjectTranslatorProxy proxy, RealStatePtr L, int idx, out UnityEngine.Color val)
		{
			...
			if (Utils.LoadField(L, idx, "r"))
            {
                ...
                proxy.translator.Get(L, top + 1, out val.r);
			...
			if (Utils.LoadField(L, idx, "g"))
            {
                ...
                proxy.translator.Get(L, top + 1, out val.g);
			...
			if (Utils.LoadField(L, idx, "b"))
            {
                ...
                proxy.translator.Get(L, top + 1, out val.b);
			...
			if (Utils.LoadField(L, idx, "a"))
            {
                ...
                proxy.translator.Get(L, top + 1, out val.a);
		...
		public static void UnPack(ObjectTranslatorProxy proxy, RealStatePtr L, int idx, out UnityEngine.Quaternion val)
		{
		...
		public static void UnPack(ObjectTranslatorProxy proxy, RealStatePtr L, int idx, out UnityEngine.Ray val)
		{
			...
			if (Utils.LoadField(L, idx, "origin"))
            {
				...
				proxy.translator.Get(L, top + 1, out origin);
				val.origin = origin;
			...
			if (Utils.LoadField(L, idx, "direction"))
            {
				...
				proxy.translator.Get(L, top + 1, out direction);
		...
		public static void UnPack(ObjectTranslatorProxy proxy, RealStatePtr L, int idx, out UnityEngine.Bounds val)
		{
			...
			if (Utils.LoadField(L, idx, "center"))
            {
				...
				proxy.translator.Get(L, top + 1, out center);
				val.center = center;
			...
			if (Utils.LoadField(L, idx, "extents"))
            {
				...
				proxy.translator.Get(L, top + 1, out extents);
				val.extents = extents;
		...
		public static void UnPack(ObjectTranslatorProxy proxy, RealStatePtr L, int idx, out UnityEngine.Ray2D val)
		{
