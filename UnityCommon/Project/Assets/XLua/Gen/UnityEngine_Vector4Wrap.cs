    ...
    public class UnityEngineVector4Wrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 5 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5))
				{
					...
					proxy.PushUnityEngineVector4(L, gen_ret);
				...
				{
				    proxy.PushUnityEngineVector4(L, default(UnityEngine.Vector4));
			        return 1;
				}
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<UnityEngine.Vector4>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					UnityEngine.Vector4 gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
        ...
        static int __AddMeta(RealStatePtr L)
        {
			...
			try {
				...
				{
					UnityEngine.Vector4 leftside;proxy.Get(L, 1, out leftside);
					UnityEngine.Vector4 rightside;proxy.Get(L, 2, out rightside);
					
					proxy.PushUnityEngineVector4(L, leftside + rightside);
        ...
        static int __UnmMeta(RealStatePtr L)
        {
            ...
            try {
                UnityEngine.Vector4 rightside;proxy.Get(L, 1, out rightside);
                proxy.PushUnityEngineVector4(L, - rightside);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
		    ...
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Set( _newX, _newY, _newZ, _newW );
                        ...
                        proxy.UpdateUnityEngineVector4(L, 1, gen_to_be_invoked);
        ...
        static int _m_Lerp_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector4 _a;proxy.Get(L, 1, out _a);
                    UnityEngine.Vector4 _b;proxy.Get(L, 2, out _b);
        ...
        static int _m_MoveTowards_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector4 _current;proxy.Get(L, 1, out _current);
                    UnityEngine.Vector4 _target;proxy.Get(L, 2, out _target);
        ...
        static int _m_Scale(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector4 _scale;proxy.Get(L, 2, out _scale);
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector4 _other;proxy.Get(L, 2, out _other);
        ...
        static int _m_Min_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector4 _lhs;proxy.Get(L, 1, out _lhs);
                    UnityEngine.Vector4 _rhs;proxy.Get(L, 2, out _rhs);
        ...
        static int _g_get_normalized(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Vector4 gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                proxy.PushUnityEngineVector4(L, gen_to_be_invoked.normalized);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_zero(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineVector4(L, UnityEngine.Vector4.zero);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_one(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineVector4(L, UnityEngine.Vector4.one);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_positiveInfinity(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineVector4(L, UnityEngine.Vector4.positiveInfinity);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_negativeInfinity(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineVector4(L, UnityEngine.Vector4.negativeInfinity);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
