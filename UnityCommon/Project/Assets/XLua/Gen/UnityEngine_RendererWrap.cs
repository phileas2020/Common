    ...
    public class UnityEngineRendererWrap 
    {
        ...
        static int _m_ResetBounds(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.CustomFastGetCSObj(L, 1);
        ...
        static int _g_get_bounds(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineBounds(L, gen_to_be_invoked.bounds);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_localBounds(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineBounds(L, gen_to_be_invoked.localBounds);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_lightmapScaleOffset(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineVector4(L, gen_to_be_invoked.lightmapScaleOffset);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_realtimeLightmapScaleOffset(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineVector4(L, gen_to_be_invoked.realtimeLightmapScaleOffset);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_bounds(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.Bounds gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_shadowCastingMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.Rendering.ShadowCastingMode gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_motionVectorGenerationMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.MotionVectorGenerationMode gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_lightProbeUsage(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.Rendering.LightProbeUsage gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_reflectionProbeUsage(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.Rendering.ReflectionProbeUsage gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_rayTracingMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.Experimental.Rendering.RayTracingMode gen_value;proxy.Get(L, 2, out gen_value);
