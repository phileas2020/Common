    ...
    public class UnityEngineVideoVideoPlayerWrap 
    {
        ...
        static int _m_Prepare(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Video.VideoPlayer gen_to_be_invoked = (UnityEngine.Video.VideoPlayer)translator.CustomFastGetCSObj(L, 1);
        ...
        static int _s_set_source(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Video.VideoPlayer gen_to_be_invoked = (UnityEngine.Video.VideoPlayer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.Video.VideoSource gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_renderMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Video.VideoPlayer gen_to_be_invoked = (UnityEngine.Video.VideoPlayer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.Video.VideoRenderMode gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_aspectRatio(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Video.VideoPlayer gen_to_be_invoked = (UnityEngine.Video.VideoPlayer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.Video.VideoAspectRatio gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_targetCamera3DLayout(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Video.VideoPlayer gen_to_be_invoked = (UnityEngine.Video.VideoPlayer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.Video.Video3DLayout gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_timeSource(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Video.VideoPlayer gen_to_be_invoked = (UnityEngine.Video.VideoPlayer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.Video.VideoTimeSource gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_timeReference(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Video.VideoPlayer gen_to_be_invoked = (UnityEngine.Video.VideoPlayer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.Video.VideoTimeReference gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_audioOutputMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Video.VideoPlayer gen_to_be_invoked = (UnityEngine.Video.VideoPlayer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.Video.VideoAudioOutputMode gen_value;proxy.Get(L, 2, out gen_value);
