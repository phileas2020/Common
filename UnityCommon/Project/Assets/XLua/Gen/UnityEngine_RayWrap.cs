    ...
    public class UnityEngineRayWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
					UnityEngine.Vector3 _origin;proxy.Get(L, 2, out _origin);
					UnityEngine.Vector3 _direction;proxy.Get(L, 3, out _direction);
					
					var gen_ret = new UnityEngine.Ray(_origin, _direction);
					proxy.PushUnityEngineRay(L, gen_ret);
				...
				{
				    proxy.PushUnityEngineRay(L, default(UnityEngine.Ray));
			        return 1;
				}
        ...
        static int _m_GetPoint(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Ray gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                ...
                
                {
                    float _distance = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        proxy.UpdateUnityEngineRay(L, 1, gen_to_be_invoked);
        ...
        static int _g_get_origin(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Ray gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.origin);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_direction(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Ray gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.direction);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
