    ...
    public class UnityEngineAudioSourceWrap 
    {
        ...
        static int _m_PlayOnGamepad(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AudioSource gen_to_be_invoked = (UnityEngine.AudioSource)translator.CustomFastGetCSObj(L, 1);
        ...
        static int _m_GamepadSpeakerSupportsOutputType_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.GamepadSpeakerOutputType _outputType;proxy.Get(L, 1, out _outputType);
        ...
        static int _m_SetCustomCurve(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.AudioSourceCurveType _type;proxy.Get(L, 2, out _type);
        ...
        static int _m_GetSpectrumData(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    float[] _samples = (float[])translator.GetObject(L, 2, typeof(float[]));
                    int _channel = LuaAPI.xlua_tointeger(L, 3);
                    UnityEngine.FFTWindow _window;proxy.Get(L, 4, out _window);
        ...
        static int _s_set_gamepadSpeakerOutputType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AudioSource gen_to_be_invoked = (UnityEngine.AudioSource)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.GamepadSpeakerOutputType gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_velocityUpdateMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AudioSource gen_to_be_invoked = (UnityEngine.AudioSource)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.AudioVelocityUpdateMode gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_rolloffMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AudioSource gen_to_be_invoked = (UnityEngine.AudioSource)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.AudioRolloffMode gen_value;proxy.Get(L, 2, out gen_value);
