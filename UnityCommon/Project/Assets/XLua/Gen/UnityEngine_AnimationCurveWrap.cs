    ...
    public class UnityEngineAnimationCurveWrap 
    {
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<UnityEngine.AnimationCurve>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					UnityEngine.AnimationCurve gen_to_be_invoked = (UnityEngine.AnimationCurve)translator.CustomFastGetCSObj(L, 1);
        ...
        static int _m_AddKey(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Keyframe _key;proxy.Get(L, 2, out _key);
        ...
        static int _m_MoveKey(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Keyframe _key;proxy.Get(L, 3, out _key);
