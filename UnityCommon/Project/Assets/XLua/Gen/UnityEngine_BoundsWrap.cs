    ...
    public class UnityEngineBoundsWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
					UnityEngine.Vector3 _center;proxy.Get(L, 2, out _center);
					UnityEngine.Vector3 _size;proxy.Get(L, 3, out _size);
					
					var gen_ret = new UnityEngine.Bounds(_center, _size);
					proxy.PushUnityEngineBounds(L, gen_ret);
				...
				{
				    proxy.PushUnityEngineBounds(L, default(UnityEngine.Bounds));
			        return 1;
				}
        ...
        static int __EqMeta(RealStatePtr L)
        {
			...
			try {
				...
				{
					UnityEngine.Bounds leftside;proxy.Get(L, 1, out leftside);
					UnityEngine.Bounds rightside;proxy.Get(L, 2, out rightside);
        ...
        static int _m_GetHashCode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Bounds gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                ...
                
                {
                        ...
                        proxy.UpdateUnityEngineBounds(L, 1, gen_to_be_invoked);
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Bounds _other;proxy.Get(L, 2, out _other);
        ...
        static int _m_SetMinMax(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 _min;proxy.Get(L, 2, out _min);
                    UnityEngine.Vector3 _max;proxy.Get(L, 3, out _max);
        ...
        static int _m_Encapsulate(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Bounds>(L, 2)) 
                {
                    UnityEngine.Bounds _bounds;proxy.Get(L, 2, out _bounds);
        ...
        static int _m_Expand(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _amount;proxy.Get(L, 2, out _amount);
        ...
        static int _m_IntersectRay(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Ray _ray;proxy.Get(L, 2, out _ray);
        ...
        static int _g_get_center(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Bounds gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.center);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_size(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Bounds gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.size);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_extents(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Bounds gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.extents);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_min(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Bounds gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.min);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_max(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Bounds gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.max);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
