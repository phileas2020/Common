    ...
    public class UnityEngineParticleSystemWrap 
    {
        ...
        static int _m_SetParticles(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem gen_to_be_invoked = (UnityEngine.ParticleSystem)translator.CustomFastGetCSObj(L, 1);
                ...
                {
                    Unity.Collections.NativeArray<UnityEngine.ParticleSystem.Particle> _particles;proxy.Get(L, 2, out _particles);
        ...
        static int _m_SetCustomParticleData(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.ParticleSystemCustomData _streamIndex;proxy.Get(L, 3, out _streamIndex);
        ...
        static int _m_SetPlaybackState(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.ParticleSystem.PlaybackState _playbackState;proxy.Get(L, 2, out _playbackState);
        ...
        static int _m_GetTrails(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.ParticleSystem.Trails _trailData;proxy.Get(L, 2, out _trailData);
        ...
        static int _m_Stop(RealStatePtr L)
        {
		    try {
                ...
                {
                    bool _withChildren = LuaAPI.lua_toboolean(L, 2);
                    UnityEngine.ParticleSystemStopBehavior _stopBehavior;proxy.Get(L, 3, out _stopBehavior);
        ...
        static int _m_Emit(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.ParticleSystem.EmitParams _emitParams;proxy.Get(L, 2, out _emitParams);
        ...
        static int _m_TriggerSubEmitter(RealStatePtr L)
        {
		    try {
                ...
                {
                    int _subEmitterIndex = LuaAPI.xlua_tointeger(L, 2);
                    UnityEngine.ParticleSystem.Particle _particle;proxy.Get(L, 3, out _particle);
        ...
        static int _m_AllocateCustomDataAttribute(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.ParticleSystemCustomData _stream;proxy.Get(L, 2, out _stream);
