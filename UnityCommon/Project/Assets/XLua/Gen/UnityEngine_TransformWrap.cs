    ...
    public class UnityEngineTransformWrap 
    {
        ...
        static int _m_SetParent(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Transform gen_to_be_invoked = (UnityEngine.Transform)translator.CustomFastGetCSObj(L, 1);
        ...
        static int _m_SetPositionAndRotation(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 _position;proxy.Get(L, 2, out _position);
                    UnityEngine.Quaternion _rotation;proxy.Get(L, 3, out _rotation);
        ...
        static int _m_Translate(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 _translation;proxy.Get(L, 2, out _translation);
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& translator.Assignable<UnityEngine.Space>(L, 5)) 
                {
                    ...
                    float _y = (float)LuaAPI.lua_tonumber(L, 3);
                    float _z = (float)LuaAPI.lua_tonumber(L, 4);
                    UnityEngine.Space _relativeTo;proxy.Get(L, 5, out _relativeTo);
                ...
                {
                    UnityEngine.Vector3 _translation;proxy.Get(L, 2, out _translation);
                    UnityEngine.Space _relativeTo;proxy.Get(L, 3, out _relativeTo);
        ...
        static int _m_Rotate(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _eulers;proxy.Get(L, 2, out _eulers);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<UnityEngine.Space>(L, 4)) 
                {
                    UnityEngine.Vector3 _axis;proxy.Get(L, 2, out _axis);
                    float _angle = (float)LuaAPI.lua_tonumber(L, 3);
                    UnityEngine.Space _relativeTo;proxy.Get(L, 4, out _relativeTo);
        ...
        static int _m_RotateAround(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 _point;proxy.Get(L, 2, out _point);
        ...
        static int _m_LookAt(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _worldPosition;proxy.Get(L, 2, out _worldPosition);
                ...
                {
                    UnityEngine.Transform _target = (UnityEngine.Transform)translator.GetObject(L, 2, typeof(UnityEngine.Transform));
                    UnityEngine.Vector3 _worldUp;proxy.Get(L, 3, out _worldUp);
        ...
        static int _m_TransformDirection(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _direction;proxy.Get(L, 2, out _direction);
        ...
        static int _m_TransformVector(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _vector;proxy.Get(L, 2, out _vector);
        ...
        static int _g_get_position(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Transform gen_to_be_invoked = (UnityEngine.Transform)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.position);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_localPosition(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Transform gen_to_be_invoked = (UnityEngine.Transform)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.localPosition);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_localEulerAngles(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Transform gen_to_be_invoked = (UnityEngine.Transform)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.localEulerAngles);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_right(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Transform gen_to_be_invoked = (UnityEngine.Transform)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.right);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_up(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Transform gen_to_be_invoked = (UnityEngine.Transform)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.up);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_forward(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Transform gen_to_be_invoked = (UnityEngine.Transform)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.forward);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_rotation(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Transform gen_to_be_invoked = (UnityEngine.Transform)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineQuaternion(L, gen_to_be_invoked.rotation);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_localRotation(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Transform gen_to_be_invoked = (UnityEngine.Transform)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineQuaternion(L, gen_to_be_invoked.localRotation);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_localScale(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Transform gen_to_be_invoked = (UnityEngine.Transform)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.localScale);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_lossyScale(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Transform gen_to_be_invoked = (UnityEngine.Transform)translator.CustomFastGetCSObj(L, 1);
                proxy.PushUnityEngineVector3(L, gen_to_be_invoked.lossyScale);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_rotation(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Transform gen_to_be_invoked = (UnityEngine.Transform)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.Quaternion gen_value;proxy.Get(L, 2, out gen_value);
