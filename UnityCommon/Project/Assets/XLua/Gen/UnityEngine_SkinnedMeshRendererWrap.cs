    ...
    public class UnityEngineSkinnedMeshRendererWrap 
    {
        ...
        static int _m_GetBlendShapeWeight(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.SkinnedMeshRenderer gen_to_be_invoked = (UnityEngine.SkinnedMeshRenderer)translator.CustomFastGetCSObj(L, 1);
        ...
        static int _s_set_quality(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.SkinnedMeshRenderer gen_to_be_invoked = (UnityEngine.SkinnedMeshRenderer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.SkinQuality gen_value;proxy.Get(L, 2, out gen_value);
        ...
        static int _s_set_vertexBufferTarget(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.SkinnedMeshRenderer gen_to_be_invoked = (UnityEngine.SkinnedMeshRenderer)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.GraphicsBuffer.Target gen_value;proxy.Get(L, 2, out gen_value);
