    ...
    public class UnityEngineVector2Wrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
					...
					proxy.PushUnityEngineVector2(L, gen_ret);
				...
				{
				    proxy.PushUnityEngineVector2(L, default(UnityEngine.Vector2));
			        return 1;
				}
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<UnityEngine.Vector2>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					UnityEngine.Vector2 gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
        ...
        static int __AddMeta(RealStatePtr L)
        {
			...
			try {
				...
				{
					UnityEngine.Vector2 leftside;proxy.Get(L, 1, out leftside);
					UnityEngine.Vector2 rightside;proxy.Get(L, 2, out rightside);
					
					proxy.PushUnityEngineVector2(L, leftside + rightside);
        ...
        static int __UnmMeta(RealStatePtr L)
        {
            ...
            try {
                UnityEngine.Vector2 rightside;proxy.Get(L, 1, out rightside);
                proxy.PushUnityEngineVector2(L, - rightside);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
		    ...
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Set( _newX, _newY );
                        ...
                        proxy.UpdateUnityEngineVector2(L, 1, gen_to_be_invoked);
        ...
        static int _m_Lerp_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector2 _a;proxy.Get(L, 1, out _a);
                    UnityEngine.Vector2 _b;proxy.Get(L, 2, out _b);
        ...
        static int _m_MoveTowards_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector2 _current;proxy.Get(L, 1, out _current);
                    UnityEngine.Vector2 _target;proxy.Get(L, 2, out _target);
        ...
        static int _m_Scale(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector2 _scale;proxy.Get(L, 2, out _scale);
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector2 _other;proxy.Get(L, 2, out _other);
        ...
        static int _m_Reflect_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector2 _inDirection;proxy.Get(L, 1, out _inDirection);
                    UnityEngine.Vector2 _inNormal;proxy.Get(L, 2, out _inNormal);
        ...
        static int _m_Dot_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector2 _lhs;proxy.Get(L, 1, out _lhs);
                    UnityEngine.Vector2 _rhs;proxy.Get(L, 2, out _rhs);
        ...
        static int _m_Angle_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector2 _from;proxy.Get(L, 1, out _from);
                    UnityEngine.Vector2 _to;proxy.Get(L, 2, out _to);
        ...
        static int _m_ClampMagnitude_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector2 _vector;proxy.Get(L, 1, out _vector);
        ...
        static int _m_SmoothDamp_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2>(L, 1)&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& translator.Assignable<UnityEngine.Vector2>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    UnityEngine.Vector2 _current;proxy.Get(L, 1, out _current);
                    UnityEngine.Vector2 _target;proxy.Get(L, 2, out _target);
                    UnityEngine.Vector2 _currentVelocity;proxy.Get(L, 3, out _currentVelocity);
                    float _smoothTime = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        proxy.PushUnityEngineVector2(L, gen_ret);
                    proxy.PushUnityEngineVector2(L, _currentVelocity);
                        proxy.UpdateUnityEngineVector2(L, 3, _currentVelocity);
        ...
        static int _g_get_normalized(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Vector2 gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                proxy.PushUnityEngineVector2(L, gen_to_be_invoked.normalized);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_zero(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineVector2(L, UnityEngine.Vector2.zero);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_one(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineVector2(L, UnityEngine.Vector2.one);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_up(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineVector2(L, UnityEngine.Vector2.up);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_down(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineVector2(L, UnityEngine.Vector2.down);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_left(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineVector2(L, UnityEngine.Vector2.left);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_right(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineVector2(L, UnityEngine.Vector2.right);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_positiveInfinity(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineVector2(L, UnityEngine.Vector2.positiveInfinity);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_negativeInfinity(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineVector2(L, UnityEngine.Vector2.negativeInfinity);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
