    ...
    public class UnityEngineColorWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 5 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5))
				{
					...
					proxy.PushUnityEngineColor(L, gen_ret);
				...
				{
				    proxy.PushUnityEngineColor(L, default(UnityEngine.Color));
			        return 1;
				}
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<UnityEngine.Color>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					UnityEngine.Color gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
        ...
        static int __AddMeta(RealStatePtr L)
        {
			...
			try {
				...
				{
					UnityEngine.Color leftside;proxy.Get(L, 1, out leftside);
					UnityEngine.Color rightside;proxy.Get(L, 2, out rightside);
					
					proxy.PushUnityEngineColor(L, leftside + rightside);
        ...
        static int _m_ToString(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        proxy.UpdateUnityEngineColor(L, 1, gen_to_be_invoked);
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Color _other;proxy.Get(L, 2, out _other);
        ...
        static int _m_Lerp_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Color _a;proxy.Get(L, 1, out _a);
                    UnityEngine.Color _b;proxy.Get(L, 2, out _b);
        ...
        static int _m_RGBToHSV_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Color _rgbColor;proxy.Get(L, 1, out _rgbColor);
                    float _H;
                    float _S;
                    float _V;
        ...
        static int _g_get_red(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineColor(L, UnityEngine.Color.red);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_green(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineColor(L, UnityEngine.Color.green);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_blue(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineColor(L, UnityEngine.Color.blue);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_white(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineColor(L, UnityEngine.Color.white);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_black(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineColor(L, UnityEngine.Color.black);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_yellow(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineColor(L, UnityEngine.Color.yellow);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_cyan(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineColor(L, UnityEngine.Color.cyan);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_magenta(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineColor(L, UnityEngine.Color.magenta);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_gray(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineColor(L, UnityEngine.Color.gray);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_grey(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineColor(L, UnityEngine.Color.grey);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_clear(RealStatePtr L)
        {
		    try {
			    ...
			    proxy.PushUnityEngineColor(L, UnityEngine.Color.clear);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_linear(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Color gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                proxy.PushUnityEngineColor(L, gen_to_be_invoked.linear);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_gamma(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Color gen_to_be_invoked;proxy.Get(L, 1, out gen_to_be_invoked);
                proxy.PushUnityEngineColor(L, gen_to_be_invoked.gamma);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
