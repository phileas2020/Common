    ...
    public class UnityEngineAnimationClipWrap 
    {
        ...
        static int _m_SampleAnimation(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AnimationClip gen_to_be_invoked = (UnityEngine.AnimationClip)translator.CustomFastGetCSObj(L, 1);
        ...
        static int _s_set_wrapMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AnimationClip gen_to_be_invoked = (UnityEngine.AnimationClip)translator.CustomFastGetCSObj(L, 1);
                UnityEngine.WrapMode gen_value;proxy.Get(L, 2, out gen_value);
